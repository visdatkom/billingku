<template>
    <div class="card" id="custom-state-button">
        ...
        <div class="card-body btn-showcase"><a class="btn btn-primary" href="javascript:void(0)" title="btn btn-primary"
                role="button">Link</a>
    ...
    <div class="card" id="outline-bold-button">
        ...
        <div class="card-body btn-showcase">
            <button class="btn " :class="item.classes" v-for="(item, index) in data1" :key="index" type="button">{{
                item.title }}</button>
        </div>
    </div>
    <div class="card" id="outline-large-button">
        ...
        <div class="card-body btn-showcase">
            <button class="btn  btn-lg" :class="item.classes" v-for="(item, index) in data" :key="index" type="button">{{
                item.title }}</button>
        </div>
    </div>
    <div class="card" id="outline-small-button">
        ...
        <div class="card-body btn-showcase">
            <button class="btn  btn-sm" :class="item.classes" v-for="(item, index) in data" :key="index" type="button">{{
                item.title }}</button>
        </div>
    </div>
    <div class="card" id="ex-outline-small-button">
        <div class="card-header pb-0">
            ...
            <span>Add <code>.btn-outline-*</code> class for outline and <code>.btn-xs</code> class for extra small
                button</span>
        </div>
        <div class="card-body btn-showcase">
            <button class="btn  btn-xs" :class="item.classes" v-for="(item, index) in data" :key="index" type="button">{{
                item.title }}</button>
    ...
    <div class="card">
        ...
        <div class="card-body btn-showcase">
            <button class="btn  disabled" :class="item.classes" v-for="(item, index) in data" :key="index"
    ...
    <div class="card" id="gradiant">
        ...
        <div class="card-body btn-showcase">
            <button class="btn " :class="item.classes" v-for="(item, index) in data2" :key="index" type="button">{{
                item.title }}</button>
        </div>
    </div>
</template>
...
const data = store.color
const data1 = store.outline
const data2 = store.gradien
</script>