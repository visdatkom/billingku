        ...
        <div class="card profile-header">
            ...
            <div class="userpro-box">
                <div class="img-wrraper">
                    <div class="avatar" id="profile-tour"><img class="img-fluid" id="profile-tour" alt=""
                            :src="getImages('user/7.jpg')" data-intro="This is Profile image"></div><a class="icon-wrapper"
                        id="update-profile-tour" href=""><nuxt-link to="/users/edit"><i
                                class="icofont icofont-pencil-alt-5"></i></nuxt-link></a>
                </div>
