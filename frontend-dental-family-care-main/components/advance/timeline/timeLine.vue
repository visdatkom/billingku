        ...
        <section class="cd-container" id="cd-timeline">
            <div class="cd-timeline-block">
                ...
                <div class="cd-timeline-content">
                    ...
                    <p class="m-0">Make sure you pick out a good luck new job card to go with the words, and pop a beautiful
                        bunch of flowers from our gift range in your basket, to make them feel super special.</p><span
                        class="cd-date">Jan <span class="counter">
                            14</span></span>
                </div>
            </div>
            <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-block">
                ...
                <div class="cd-timeline-content">
                    <h4>3. Layout Drafts</h4><img class="img-fluid p-t-20" :src="getImages('banner/1.jpg')" alt=""><span
                        class="cd-date">Jan <span class="counter">24</span></span>
                </div>
            </div>
            <div class="cd-timeline-block">
                ...
                <div class="cd-timeline-content">
                    ...
                    <audio class="m-t-20" controls>
                        <source src="@/assets/audio/horse.ogg" type="audio/ogg"> Your browser does not support the
                        audio element.
            ...
            <div class="cd-timeline-block">
                ...
                <div class="cd-timeline-content">
                    <h4>5. Team Work</h4><img class="img-fluid p-t-20" :src="getImages('banner/3.jpg')" alt=""><span
                        class="cd-date">Feb <span class="counter">18</span></span>
                </div>
            </div>
            <div class="cd-timeline-block">
                ...
                <div class="cd-timeline-content">
                    <h4>Final Testing</h4>
                    <p class="m-0">Explain any new understanding or fresh insights about the problem. This is the content of
                        the Final Testing.</p><span class="cd-date">Feb <span class="counter">26</span></span>
                </div>
            </div>
        </section>
    </div>
