                    ...
                    <div class="card">
                        <div class="animate-widget">
                            ...
                            <div class="text-center p-25">
                                <p class="text-muted mb-0">Denouncing pleasure and praising pain was born and I will
                        ...
                        <div class="modal-body">
                            <div class="card">
                                <div class="animate-widget">
                                    <div><img class="img-fluid" :src="getImages('banner/3.jpg')" alt=""></div>
                                    <div class="text-center p-25">
                                        <p class="text-muted mb-0">asdasdsadsad pleasure and praising pain was born and
                                            I will give you a
