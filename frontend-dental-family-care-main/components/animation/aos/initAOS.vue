<template>
    ...
    <div class="card">
        <div class="card-header pb-0">
            <h5>How to use it?</h5><span>All you have to do is to add <code>data-aos</code> attribute to html
    ...
    <div class="card">
        <div class="card-header pb-0">
            <h5> Advanced settings</h5><span>These settings can be set both on certain elements, or as default while
                initializing script (in options object without <code> data- part).</code></span>
        </div>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Anchor placement - which one position of element on the screen should trigger animation
                        </td>
                        <td>top-center</td>
                        <td>top-bottom</td>
                    </tr>
                    <tr>
                        ...
                        <td>Choose wheter animation should fire once, or every time you scroll up/down to element
                        </td>
                        <td>true</td>
                        <td>false</td>
                    </tr>
