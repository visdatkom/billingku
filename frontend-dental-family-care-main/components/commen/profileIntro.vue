        ...
        <div class="default-according style-1 faq-accordion job-accordion" id="accordionoc1">
            <div class="row">
                        ...
                        <div class="card-header">
                            <h5 class="p-0">
                                <button class="btn btn-link ps-0" data-bs-toggle="collapse" data-bs-target="#collapseicon2"
                                    ...
                                    :class="[isActive ? 'active' : '', 'collapsible']" v-on:click="toggle">Profile
                                    Intro</button>
                            </h5>
                        </div>
                        <div :class="[isActive ? 'block' : ' show']" v-show="isActive">
                            <div class="card-body filter-cards-view">
                                ...
                                <div class="social-network theme-form"><span class="f-w-600">Social Networks</span><a
                                        ...
                                        class="btn social-btn btn-twitter mb-2 text-center" href="https://twitter.com/"><i
                ...
                <div class="col-xl-12 col-sm-6 xl-100 box-col-12">
                    <div class="card"><img class="img-fluid" :src="getImages('social-app/timeline-4.png')" alt="">
                    </div>
                </div>
            </div>
        </div>
