      ...
      <div class="card-body">
        ...
        <section class="cd-container" id="cd-timeline">
          ...
          <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-content">
              <h4>3. Layout Drafts</h4><img class="img-fluid p-t-20" src="/images/banner/1.jpg" alt=""><span
          ...
          <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-content">
              <h4>5. Team Work</h4><img class="img-fluid p-t-20" src="/images/banner/3.jpg" alt=""><span
          ...
          <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-content">
              <h4>Final Testing</h4>
              <p class="m-0">Explain any new understanding or fresh insights about the problem. This is the content of the
                Final Testing.</p>
