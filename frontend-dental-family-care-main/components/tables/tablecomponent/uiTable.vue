                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span>Bootstrap includes six predefined button styles, each serving its own
                                                semantic purpose.</span></td>
                                    </tr>
                                    <tr>
                                        <td>Round Buttons</td>
                                        <td>
                                        ...
                                        <td><span>Use <code>.btn-pill</code> class to button for Round Buttons.</span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><span>Use <code>btn-group</code> class to button for <code>div</code>.</span>
                                        </td>
                                    </tr>
                                    <tr>
