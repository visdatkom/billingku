    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Sizing Tables</h5><span>Example of Extra large table, Add <code>.table-xl</code> class to the
                    <code>.table</code> , Large table Add <code>.table-lg</code> , Default table Add
