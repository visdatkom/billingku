<template>
    <div class="fade tab-pane" id="pills-todaytask" role="tabpanel"
        v-bind:class="(store.activeclass === 'pills-todaytask') ? 'active show' : ''" aria-labelledby="pills-todaytask-tab">
        <div class="card mb-0">
            <div class="card-header d-flex">
                <h6 class="mb-0">Today's Tasks</h6><a href="javascript:void(0)" @click="printWindow()">
