            ...
            <div class="card-body">
                <div class="row icon-lists">
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3" v-for="(dire, index) in directionalIcons" :key="index"
                        v-on:click="iconBar(dire.name)">
                        <i :class="'fa fa-' + dire.name"></i>{{ dire.name }}
                    </div>
