    ...
    <div class="col-sm-12 col-xl-6">
        <div class="card">
            <div class="card-header pb-0">
                <h5>Basic Accordion</h5><span>Using the <a href="javascript:void(0)">card</a> component, you can extend
                ...
                <div class="default-according" id="accordion">
                    <div class="card">
                        <div class="card-header" id="headingOne">
                            <h5 class="mb-0">
                                <button class="btn btn-link ps-0" data-bs-toggle="collapse" data-bs-target="#collapseOne"
