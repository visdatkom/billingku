<template>
    <div class="col-sm-12 col-xl-6">
        <div class="card">
            ...
            <div class="card-body badge-card"><span class="badge badge-primary">Primary</span><span
    ...
    <div class="col-sm-12 col-xl-6">
        <div class="card">
            ...
            <div class="card-body badge-card"><span class="badge rounded-pill badge-primary">Primary</span><span
