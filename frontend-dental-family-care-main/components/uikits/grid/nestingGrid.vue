<template>
    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body grid-showcase">
                <p>Use <code>.order-</code> classes for controlling the <strong>visual order</strong> of your content.
                    These classes are responsive, so you can set the <code>order</code> by breakpoint (e.g.,
    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body grid-showcase">
                <p>Move columns to the right using <code>.offset-md-*</code> classes. These classes increase the left
