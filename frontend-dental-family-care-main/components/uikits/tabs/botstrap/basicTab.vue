            ...
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle bg-transparent border-none"
                            ...
                            aria-expanded="false" @click="open()">Dropdown</a>
                        <div class="dropdown-menu" :class="filter ? 'show' : ''"><a class="dropdown-item" id="profile-tab"
                                data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                                aria-selected="false">Action</a><a class="dropdown-item" href="javascript:void(0)">Another
                                action</a><a class="dropdown-item" href="javascript:void(0)">Something else here</a><a
                                class="dropdown-item" href="javascript:void(0)">Separated link</a></div>
                    </li>
