            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs border-tab" id="bottom-tab" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link" id="profile-bottom-tab" data-bs-toggle="tab"
                            href="#bottom-profile" role="tab" aria-controls="bottom-profile" aria-selected="false"><i
                    ...
                    <li class="nav-item"><a class="nav-link" id="contact-bottom-tab" data-bs-toggle="tab"
                            href="#bottom-contact" role="tab" aria-controls="bottom-contact" aria-selected="false"><i
                                class="icofont icofont-contacts"></i>Contact</a></li>
                </ul>
            </div>
        </div>
