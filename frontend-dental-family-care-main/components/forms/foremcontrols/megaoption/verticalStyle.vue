    ...
    <div class="col-sm-12 box-col-12 col-xl-12 col-xxl-6">
        <div class="card height-equal">
            <div class="card-header pb-0">
                <h5>Vertical Style</h5><span>For Create inline megaoption add <code>.mega-vertical</code> class in form
                    tag</span>
            </div>
            <div class="card-body">
                                ...
                                <div class="media p-20">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="rating-star-wrapper"><i class="icofont icofont-star txt-warning"></i><i
                                                ...
                                                class="icofont icofont-star"></i><i class="icofont icofont-star m-r-5"></i>1
                                            start rating</p>
                                    </div>
                                </div>
                            </div>
