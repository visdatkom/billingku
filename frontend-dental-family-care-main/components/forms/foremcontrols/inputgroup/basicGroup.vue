                    ...
                    <div class="col">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group"><span class="input-group-text"><i
                                            class="icofont icofont-unlink"></i></span><span class="input-group-text">0.00
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3"><span class="input-group-text"><i
                                            class="icon-zoom-out"></i></span>
                                    <input class="form-control" type="text"
                                        aria-label="Amount (to the nearest dollar)"><span class="input-group-text"><i
                                            class="icon-zoom-in"></i></span>
                                </div>
                            </div>
                            ...
                            <div>
                                <label class="form-label">Left & Right Addon</label>
                                <div class="input-group pill-input-group"><span class="input-group-text"><i
                                            class="icofont icofont-ui-copy"> </i></span>
                                    <input class="form-control" type="text"
                                        aria-label="Amount (to the nearest dollar)"><span class="input-group-text"><i
