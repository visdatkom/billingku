<template>
  <svg class="svg-60" viewBox="0 0 1920 1080" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="fortyfour" data-name="Layer 2">
      <g class="four a">
        <rect class="primary-color" height="466.29" rx="57.1" ry="57.1" transform="translate(918.39 330.19) rotate(90)"
        ...
        <rect class="primary-color" height="604.75" rx="60.36" ry="60.36" transform="translate(290.49 -70.78) rotate(35)"
          width="120.71" x="197.13" y="122.89"></rect>
      </g>
      <g class="four b">
        <rect class="primary-color" height="466.29" rx="57.1" ry="57.1" transform="translate(2244.26 -994.14) rotate(90)"
          width="120.71" x="1558.84" y="391.91"></rect>
      <rect class="primary-color" height="396.88" rx="60.36" ry="60.36" width="120.71" x="1658.92" y="475.87"></rect>
      <rect class="primary-color" height="604.75" rx="60.36" ry="60.36" transform="translate(530.57 -830.68) rotate(35)"
        width="120.71" x="1522.22" y="123.66"></rect>
    </g>
  ...
  <g class="bicycle" data-name="Layer 5">
    ...
    <g>
      <rect class="warning-color" height="53.21" transform="translate(-165.97 273.38) rotate(-16.19)" width="12.87"
    ...
    <g>
      <circle class="warning-color" cx="1022.66" cy="599.55" r="11.57" transform="translate(-4.86 8.38) rotate(-0.47)">
      </circle>
      <path class="warning-color"
