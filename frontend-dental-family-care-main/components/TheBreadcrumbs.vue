        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="bookmark">
                        <ul>
                            <li v-for="(item, index) in data" :key="index" v-tooltip="item.tooltip"><nuxt-link
                                    :to="item.path" data-container="body" data-bs-placement="top" title="Bookmark">
                                    <Icon :name="item.icon" class="fs-1" size="20" />
                                </nuxt-link></li>
                            <li><a href="javascript:void(0)">
                                    <Icon name="ic:baseline-star-border" v-tooltip="'Search'" @click="collapseFilter()"
                                        class="fs-1" size="20" />
                                </a>
